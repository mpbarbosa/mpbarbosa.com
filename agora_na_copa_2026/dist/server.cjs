...
var teamAnalysis_default = {
  ...
  PAR: {
    ...
    updatedAt: "2026-06-29T23:13:00-03:00"
  },
  TUR: {
  ...
  GER: {
    text: "## Leitura\nElimina\xE7\xE3o melanc\xF3lica e precoce. A Alemanha de Julian Nagelsmann liderou o Grupo E, mas caiu logo nos 16-avos de final, surpreendida pelo Paraguai nos p\xEAnaltis. Apesar do ataque avassalador na fase de grupos, a tetracampe\xE3 n\xE3o passou da estreia do mata-mata \u2014 a grande zebra do Mundial at\xE9 aqui.\n## Desempenho\nNa fase de grupos, estreou com goleada de 7 a 1 sobre Cura\xE7ao, bateu a Costa do Marfim por 2 a 1 (dois de Deniz Undav) e perdeu por 2 a 1 para o Equador j\xE1 classificada. Nos 16-avos, empatou em 1 a 1 com o Paraguai \u2014 Kai Havertz igualou aos 54\u2019 ap\xF3s o gol de Enciso \u2014, levou o jogo \xE0 prorroga\xE7\xE3o e sucumbiu nas penalidades por 4 a 3, com o goleiro Gill defendendo as cobran\xE7as de Havertz e Woltemade.\n## N\xFAmeros\nFase de grupos: 2V 1D, 10 gols marcados, 4 sofridos (SG +6), 1\xBA do Grupo E (6 pts). Nos 16-avos, eliminada pelo Paraguai (1 a 1, 3 a 4 nos p\xEAnaltis). Artilheiro na primeira fase: Deniz Undav (3 gols). Fim de linha no Mundial.",
