...
var teamAnalysis_default = {
  ...
  UZB: {
    text: "## Leitura\nEstreante hist\xF3rico em Copas do Mundo, o Uzbequist\xE3o de Fabio Cannavaro despediu-se ainda na fase de grupos, sem pontos e com a defesa em frangalhos: 11 gols sofridos, de longe o pior saldo do Grupo K. Em sua primeira participa\xE7\xE3o, a equipe sentiu a diferen\xE7a de n\xEDvel para os favoritos e termina na lanterna, eliminada.\n## Desempenho\nEstreou perdendo para a Col\xF4mbia por 3 a 1, com Abbosbek Fayzullaev marcando o gol uzbeque. Na sequ\xEAncia, foi atropelado por Portugal por 5 a 0, sem resposta para o ataque luso. No encerramento, viveu o cap\xEDtulo mais cruel: abriu o placar contra a RD Congo com Eldor Shomurodov logo aos 10 minutos, mas sofreu a virada e perdeu por 3 a 1, deixando escapar a chance de uma despedida positiva.\n## N\xFAmeros\nJ3 \xB7 3 derrotas \xB7 2 gols marcados \xB7 11 sofridos (SG -9) \xB7 4\xBA e \xFAltimo no Grupo K, eliminado. Gols de Abbosbek Fayzullaev e Eldor Shomurodov (um cada). Fim de linha: o Uzbequist\xE3o se despede do seu primeiro Mundial com li\xE7\xF5es duras na defesa.",
